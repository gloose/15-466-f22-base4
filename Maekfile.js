...
const pipeline_exe = maek.LINK([...pipeline_names, ...common_names], 'dist/pipeline')
...
maek.TARGETS = [game_exe, pipeline_exe, show_meshes_exe, show_scene_exe, freetype_test_exe, ...copies];
